		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#formacaodemocancelarreservas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"formacaodemocancelarreservas-display": {
								"semanticObject": "formacaodemocancelarreservas",
								"action": "display",
								"description": "Cancelamento de reservas",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=formacao.demo.cancelarreservas",
									"url": sap.ui.require.toUrl("formacao/demo/cancelarreservas")
								}
							}
						}
					}
